...
export default function HomeClient({ 
  ...
  return (
    <>
      ...
      {/* New Arrivals */}
      <section className="py-32 sm:py-64 bg-transparent border-t border-kaaj-charcoal/10">
      ...
      {initialCategories.length > 0 && (
        <section className="py-32 sm:py-48 bg-transparent border-t border-kaaj-charcoal/10">
      ...
      <section className="bg-transparent py-24 sm:py-32 border-t border-kaaj-charcoal/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
          <p className="font-serif text-[clamp(2rem,5vw,3rem)] text-kaaj-charcoal mb-4 leading-tight tracking-tight">
            Join the Atelier
          </p>
          <p className="font-sans text-[10px] text-kaaj-charcoal/60 mb-12 tracking-[0.4em] uppercase">
            Follow the journey
          </p>
