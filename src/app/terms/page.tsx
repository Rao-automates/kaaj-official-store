  ...
  return (
    <div className="min-h-screen bg-kaaj-cream pt-32 md:pt-48 pb-32">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-16">
          <h1 className="font-sans text-[clamp(2.5rem,8vw,5rem)] leading-[0.9] text-kaaj-charcoal tracking-tighter -ml-1 mb-8">
            Terms & Conditions.
          </h1>
        ...
        <div className="prose prose-sm md:prose-base prose-kaaj max-w-none text-kaaj-charcoal/80 font-sans leading-loose space-y-8">
          <section>
            <h2 className="font-sans text-2xl text-kaaj-charcoal mb-4">1. Agreement to Terms</h2>
            <p>
          ...
          <section>
            <h2 className="font-sans text-2xl text-kaaj-charcoal mb-4">2. Intellectual Property</h2>
            <p>
          ...
          <section>
            <h2 className="font-sans text-2xl text-kaaj-charcoal mb-4">3. Product Descriptions and Pricing</h2>
            <p>
          ...
          <section>
            <h2 className="font-sans text-2xl text-kaaj-charcoal mb-4">4. Shipping and Returns</h2>
            <p>
          ...
          <section>
            <h2 className="font-sans text-2xl text-kaaj-charcoal mb-4">5. Governing Law</h2>
            <p>
          ...
          <section>
            <h2 className="font-sans text-2xl text-kaaj-charcoal mb-4">6. DAMAGED, SHORT-MEASURED, OR DEFECTIVE ITEMS</h2>
            <p>
          ...
          <section>
            <h2 className="font-sans text-2xl text-kaaj-charcoal mb-4">7. REFUND POLICY & SALE ITEMS</h2>
            <p>
