    ...
    <div className="min-h-screen bg-kaaj-cream pt-32 md:pt-48 pb-32">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-sm md:prose-base prose-kaaj max-w-none text-kaaj-charcoal/80 font-sans leading-loose space-y-8">
          <section>
            <h2 className="font-sans text-2xl text-kaaj-charcoal mb-4">1. Information We Collect</h2>
            <p>
          ...
          <section>
            <h2 className="font-sans text-2xl text-kaaj-charcoal mb-4">2. How We Use Your Information</h2>
            <p>
          ...
          <section>
            <h2 className="font-sans text-2xl text-kaaj-charcoal mb-4">3. Data Sharing and Security</h2>
            <p>
          ...
          <section>
            <h2 className="font-sans text-2xl text-kaaj-charcoal mb-4">4. Cookies</h2>
            <p>
          ...
          <section>
            <h2 className="font-sans text-2xl text-kaaj-charcoal mb-4">5. Contact Us</h2>
            <p>
