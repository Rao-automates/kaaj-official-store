  ...
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center bg-kaaj-cream px-4 text-center">
      ...
      <div className="flex gap-6 items-center">
        ...
        <span className="text-kaaj-charcoal/70">|</span>
        ...
        >
          <span className="font-sans text-[9px] uppercase tracking-[0.3em] text-kaaj-charcoal/70 group-hover:text-kaaj-charcoal transition-colors duration-700">
            Return Home
          </span>
        </Link>
      </div>
